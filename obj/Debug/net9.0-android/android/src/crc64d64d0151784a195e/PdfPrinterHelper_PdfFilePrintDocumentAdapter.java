package crc64d64d0151784a195e;


public class PdfPrinterHelper_PdfFilePrintDocumentAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PdfFormFramework.Printing.PdfPrinterHelper+PdfFilePrintDocumentAdapter, PdfFormFramework", PdfPrinterHelper_PdfFilePrintDocumentAdapter.class, __md_methods);
	}

	public PdfPrinterHelper_PdfFilePrintDocumentAdapter ()
	{
		super ();
		if (getClass () == PdfPrinterHelper_PdfFilePrintDocumentAdapter.class) {
			mono.android.TypeManager.Activate ("PdfFormFramework.Printing.PdfPrinterHelper+PdfFilePrintDocumentAdapter, PdfFormFramework", "", this, new java.lang.Object[] {  });
		}
	}

	public PdfPrinterHelper_PdfFilePrintDocumentAdapter (android.content.Context p0, java.lang.String p1)
	{
		super ();
		if (getClass () == PdfPrinterHelper_PdfFilePrintDocumentAdapter.class) {
			mono.android.TypeManager.Activate ("PdfFormFramework.Printing.PdfPrinterHelper+PdfFilePrintDocumentAdapter, PdfFormFramework", "Android.Content.Context, Mono.Android:System.String, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1 });
		}
	}
